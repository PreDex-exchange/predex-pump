...
const STEPS = [
  {
    ...
    icon: (
      <svg aria-hidden="true" viewBox="0 0 32 32">
        ...
        <path d="m8 21 5-6 4 3 7-9" fill="none" stroke="var(--brand)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg aria-hidden="true" viewBox="0 0 32 32">
        <rect fill="var(--yes-soft)" height="20" rx="4" stroke="currentColor" strokeWidth="2" width="24" x="4" y="6" />
  ...
  },
  {
    ...
    icon: (
      <svg aria-hidden="true" viewBox="0 0 32 32">
        <circle cx="16" cy="16" fill="var(--no-soft)" r="11" stroke="currentColor" strokeWidth="2" />
        <path d="m10 16 4 4 8-9" fill="none" stroke="var(--yes)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
      </svg>
    ),
  },
] as const;
