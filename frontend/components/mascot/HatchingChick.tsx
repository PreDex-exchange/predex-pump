...
export function HatchingChick({
  ...
  return (
    ...
    >
      ...
      <ellipse cx="220" cy="340" fill="#2b2440" opacity=".08" rx="152" ry="22" />
      ...
      <circle cx="342" cy="82" fill="#ffc24b" r="4.5" />
      <circle cx="92" cy="150" fill="#3e8fe0" r="5" />
      ...
      <circle cx="220" cy="196" fill="#ffc24b" r="74" stroke="#2b2440" strokeWidth="3.5" />
      <ellipse cx="196" cy="160" fill="#ffd77a" opacity=".75" rx="26" ry="17" />

      <g stroke="#2b2440" strokeLinejoin="round" strokeWidth="3">
        <path
      ...
      <ellipse cx="185" cy="198" fill="#ff6b57" opacity=".35" rx="9" ry="6.5" />
      <ellipse cx="255" cy="198" fill="#ff6b57" opacity=".35" rx="9" ry="6.5" />
      <circle cx="199" cy="182" fill="#2b2440" r="9" />
      <circle cx="241" cy="182" fill="#2b2440" r="9" />
      <circle cx="202" cy="179" fill="#fff" r="3" />
      <circle cx="244" cy="179" fill="#fff" r="3" />
      <path
